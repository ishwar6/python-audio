...
from audio_recognizer.base_classes.common_database import CommonDatabase
from audio_recognizer.config.settings import (FIELD_FILE_SHA1, FIELD_FINGERPRINTED,
