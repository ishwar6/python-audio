...
from audio_recognizer.config.settings import (CONNECTIVITY_MASK, DEFAULT_AMP_MIN,
...
def get_2D_peaks(arr2D: np.array, plot: bool = False, amp_min: int = DEFAULT_AMP_MIN)\
    ...
    # Applying erosion, the Audio Recognizer documentation does not talk about this step.
    background = (arr2D == 0)
