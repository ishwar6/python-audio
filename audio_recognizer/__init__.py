...
from audio_recognizer.base_classes.base_database import get_database
from audio_recognizer.config.settings import (DEFAULT_FS, DEFAULT_OVERLAP_RATIO,
...
from audio_recognizer.logic.fingerprint import fingerprint
...
class AudioRecognizer:
    ...
    def fingerprint_file(self, file_path: str, song_name: str = None) -> None:
        ...
        if song_hash in self.songhashes_set:
            ...
            song_name, hashes, file_hash = AudioRecognizer._fingerprint_worker(
                file_path,
                self.limit,
                song_name=song_name
            )
    ...
    def _fingerprint_worker(arguments):
        ...
        fingerprints, file_hash = AudioRecognizer.get_file_fingerprints(file_name, limit, print_output=True)
