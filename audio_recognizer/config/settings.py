...
DATABASES = {
    # 'mysql': ("audio_recognizer.database_handler.mysql_database", "MySQLDatabase"),
...
# is the value used in the original Audio Recognizer code).
...
# for Audio Recognizer to consider it a spectral peak. Higher values mean less
